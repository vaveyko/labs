...
Const
    INFTEXT = 'Дан массив а, состоящий из n-элементов.' +
      ' Найти сумму элементов массива, стоящих на нечтных местах.';
    DIGITS = ['0' .. '9'];
    VOID = #0;
    BACKSPACE = #8;
...
Function SumOddElems(ArrOfNum: Array Of Integer): Integer;
Var
    Sum, I: Integer;
Begin
    Sum := 0;
    I := 0;
    While (I < Length(ArrOfNum)) Do
    Begin
        Sum := Sum + ArrOfNum[I];
        I := I + 2;
    End;
...
Begin
    ...
    Edit2.Text := IntToStr(SumOddElems(Arr));
    N4.Enabled := True;
    IsSaved := False;
End;
    ...
    Begin
        ...
        Begin
            ...
            Begin
                ...
                Inc(I);
                if ((I = Size) And Not Eof(InfFile)) Or ((I < Size) And Eof(InfFile)) then
...
Begin
    ...
    Begin
        ...
        Rewrite(OutFile);
        Write(OutFile, 'Сумма элементов находящихся на нечетных местах: ');
    ...
    Begin
        ...
        Begin
            ...
            If (EditingCell.SelStart = 0) And
              ...
              (EditingCell.Text[EditingCell.SelLength + 1] = '0') Then
                Key := VOID;
    ...
    Begin
        ...
        Begin
            If (EditingCell.GetTextLen > 0) And (Cells[Col, Row][1] = '-') And
              (EditingCell.SelStart = 0) And Not(EditingCell.SelLength = EditingCell.GetTextLen) Then
                Key := VOID
            Else If (Cells[Col, Row] = '0') And
              Not(EditingCell.SelLength = EditingCell.GetTextLen) Then
                Key := VOID
            Else
            Begin
